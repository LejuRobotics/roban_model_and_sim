...
def main():
    ...
    motionInit()
    UpdateTargets()
    linearTrajMove(torso=[(0.03,0.07,-0.09)], left_leg=[(0,0.00,0)], right_leg=[(0,-0.00,0)])#, left_arm=[(0.21, -0.03, 0.21)], right_arm=[(0.21, 0.03, 0.21)])
    waitUntilStable()
    ...
    print("l=", l)
    t0=sim_time.time()
    upstair(-1, h1=0, l1=0, h2=0, l2=l+0.13*sin(radians(theta)))
    upstair(1, h1=0, l1=l)
    #1+ 0
    upstair(-1)
    #1 +2
